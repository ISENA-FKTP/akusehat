...
import { FaPlus, FaMinus, FaTrash } from 'react-icons/fa'; // Mengimpor ikon-ikon yang diperlukan dari react-icons
...
const DashboardApotek = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1"> {/* margin-left disesuaikan dengan lebar sidebar */}
        <Header
                ...
                {filteredMedicines.map((medicine, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-warning-100' : 'bg-warning-200'}>
                    ...
                    <td className="border px-4 py-2 flex items-center justify-center">
                      <button onClick={() => handleIncreaseQuantity(index)} className="p-2 rounded-xl mr-2 bg-primary-300">
                        <FaPlus />
                      </button>
                      <button onClick={() => handleDecreaseQuantity(index)} className="p-2 rounded-xl mr-2 bg-primary-300">
                        <FaMinus />
                      </button>
                      <button onClick={() => handleDeleteMedicine(index)} className="p-2 rounded-xl bg-primary-300">
                        <FaTrash />
                      </button>
                    </td>
                  </tr>
