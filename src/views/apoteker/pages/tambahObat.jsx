    ...
    <div>
     <div className="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">Nama Obat</label>
            <input
              type="text"
              name="medicineName"
          ...
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">Jumlah Obat</label>
            <input
              type="number"
              name="quantity"
          ...
          <div className="mb-4 relative">
            <label className="block text-black text-sm font-bold mb-2">Tanggal Kadaluarsa</label>
          ...
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">No Batch</label>
            <input
              type="text"
              name="batchNo"
          ...
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">Kategori</label>
            <Menu as="div" className="relative">
              ...
              <Menu.Items className="absolute mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg z-10">
                {['Alkes Habis Pakai', 'Obat Cair', 'Obat Padat', 'Obat Lainnya'].map((category) => (
          ...
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">Jenis</label>
            <Menu as="div" className="relative">
              <Menu.Button className="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline">
          ...
          <div className="mb-4">
            <label className="block text-black text-sm font-bold mb-2">Harga</label>
            <input
              type="number"
              name="price"
