          ...
          <div className="absolute inset-0">
            ...
            <div className="h-28 bg-primary-600 mx-32 shadow-lg flex items-center justify-center rounded my-36 absolute left-24" style={{ width: '72%' }}>
                <h1 className="text-white font-primary-Poppins flex justify-center font-bold text-2xl absolute py-24 pt-14">
                 ...
                 <div className=" h-10 bg-primary-600 mx-32 shadow-lg rounded-t-lg absolute left-24 my-72" style={{ width: '35%' }}>
                    <h1 className="text-white font-primary-Poppins font-bold text-xl justify-center flex items-center my-1">Pengajuan</h1>
                 <div className=" h-96 border border-primary-600 mx-18 -my-8 shadow-lg rounded-b-lg absolute" style={{ width: '100%' }}>
            ...
            <div className=" h-10 bg-primary-600 shadow-lg rounded-t-lg absolute left-98 right-40 my-72" style={{ width: '35%' }}>
              <h1 className="text-white font-primary-Poppins font-bold text-xl justify-center flex items-center my-1">Keadaan Fisik</h1>
                <div className="h-60 border border-primary-600 mx-18 -my-8 shadow-lg rounded-b-lg absolute" style={{ width: '100%' }}>
            ...
            <div className="h-10 mx-36 my-96 bg-primary-600 shadow-lg rounded-t-lg absolute left-96" style={{ width: '52%' }}>
              <h1 className="text-white font-primary-Poppins font-bold text-xl justify-center flex items-center my-1">Tekanan Darah</h1>
                <div className=" h-64 border border-primary-600 shadow-lg rounded-b-lg" style={{ width: '100%' }}>
