...
const Login = () => {
  ...
  const Auth = async (e) => {
    ...
    try {
      ...
      if (decoded.role === 'statistik') {
        navigate('/kajiawal');
      } else {
        setMsg('Akses Ditolak, Silahkan Masukan Akun Manage.');
      }
    } catch (error) {
      if (error.response) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
      ...
      <div className="flex items-center justify-center bg-[#f5f5f5]">
        <div className="w-4/6 max-w-2xl p-10 bg-white shadow-2xl rounded-lg">
          ...
          <h1 className="text-2xl font-bold text-center text-primary-500">Masukan Akun Manage Anda!</h1>
          <p className="mb-2 text-center text-gray-600">Selamat Datang dan Selamat Mengelola Data Anda!</p>
